...
from ldsrs2_launcher.domain.naming import patch_output_name
from ldsrs2_launcher.domain.raster import compress_geotiff, compute_centroid_lat_lon
...
def run_inference(
    *,
    ...
    final_name = patch_output_name(latitude, longitude)
    compressed_path = output_dir / final_name
